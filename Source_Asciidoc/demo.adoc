...
You can write text https://cjay-international.com[with inline links], optionally{sp}using an explicit https://cjay-international.com[link prefix]. In either case, the link can have a https://example.com?foo=bar&lang=en[query string].
...
doc = Asciidoctor.load '*This* is https://asciidoc.org[AsciiDoc]!', header_footer: true
...
<div id="content">
<div class="paragraph">
<p><strong>This</strong> is <a href="https://asciidoc.org">AsciiDoc</a>!</p>
</div>
</div>
<div id="footer">
<div id="footer-text">
...
Or you could return to the xref:first_steps_with_asciidoc[] or <<purpose,Purpose>>.
=====
...
[[google]]When all else fails, head over to <https://google.com>.